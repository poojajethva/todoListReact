...
const Todolist = (props) => {
    ...
    let list = currObj.length > 0 ? currObj.map((item,index) => {
        ...
        const StatusBar = (props) => {
            ...
            export default {Todolist, StatusBar};
